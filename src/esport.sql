...
CREATE TABLE IF NOT EXISTS player (
    ...
    game_id INT(10),
    PRIMARY KEY (id),
    CONSTRAINT fk_team_player FOREIGN KEY (team_id) REFERENCES team(id) ON DELETE
    SET NULL,
        CONSTRAINT fk_game_player FOREIGN KEY (game_id) REFERENCES game(id) ON DELETE
    SET NULL
);
...
CREATE TABLE IF NOT EXISTS team_competition(
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_team_teamcompetition FOREIGN KEY (team_id) REFERENCES team(id) ON DELETE
    SET NULL,
        CONSTRAINT fk_competition_teamcompetition FOREIGN KEY (competition_id) REFERENCES competition(id) ON DELETE
    SET NULL
);
CREATE TABLE IF NOT EXISTS sponsor(
    ...
    team_id INT(10),
    PRIMARY KEY (id),
    CONSTRAINT fk_team_sponsor FOREIGN KEY (team_id) REFERENCES team(id) ON DELETE
    SET NULL
);
...
INSERT INTO `sponsor` (`name`, `team_id`)
VALUES ('Red Bull', 1),
    ('Intel', 1),
    ('Coca-Cola', 2),
    ('Logitech G', 3),
